...
import membership.MemberDAO_H2;
...
public class MemberAuth extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        String connectUrl = application.getInitParameter("H2URL");
        String oId = application.getInitParameter("H2Id");
        String oPass = application.getInitParameter("H2Pwd");

        // DAO 생성
        dao = new MemberDAO_H2(driver, connectUrl, oId, oPass);
    }
